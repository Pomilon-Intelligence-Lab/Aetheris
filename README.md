...
| :--- | :--- | :--- | :--- |
| **Aetheris-Base** | 17k | Early convergence checkpoint (Loss ~1.81). Good for analyzing router behavior. | [🤗 Hugging Face](https://huggingface.co/pomilon-lab/Aetheris-MoE-300M-A125M-base) |
